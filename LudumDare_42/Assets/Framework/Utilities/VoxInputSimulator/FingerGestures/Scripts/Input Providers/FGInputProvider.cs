...
{
	protected InputProviderType _inputProviderType;
	...
	public InputProviderType GetInputProviderType()
	{
		return _inputProviderType;
	}

	public virtual void InputModeDetect()
	{
