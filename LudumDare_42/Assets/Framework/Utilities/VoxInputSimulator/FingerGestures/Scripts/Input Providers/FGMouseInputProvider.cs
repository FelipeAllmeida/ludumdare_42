...
public class FGMouseInputProvider : FGInputProvider
{
    ...
    void Start()
    {
		_inputProviderType = InputProviderType.MOUSE;
    ...
    void UpdatePinchEmulation()
    {
		...
		pinchAxisMotion += pinchAxisScale * -Input.GetAxis ("Horizontal");
		pinchAxisMotion += pinchAxisScale * -Input.GetAxis ("Vertical");
